...
pc: $(TODO) format smells docs staged pytest tox  ## verify everything before commit

ci: format smells docs tox  ## verify everything in a CI server
...
tags: $(PY_SOURCE_FILES)  ## update the tags file
