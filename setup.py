...
def version_from_file():
    if not os.path.exists('dynamake/version.py'):
        raise RuntimeError('Failed to generate dynamake/version.py')

    with open('dynamake/version.py', 'r') as file:
    ...
    raise RuntimeError('Failed to parse dynamake/version.py')
...
TESTS_REQUIRE = ['nose', 'testfixtures', 'coverage', 'aiorwlock']
...
setup(name='dynamake',
      ...
      url='https://github.com/tanaylab/dynamake.git',
