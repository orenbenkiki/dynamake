...
class TestMain(TestWithFiles):
    ...
    def test_phony_dependencies(self) -> None:
        ...
        self.check(_register, log=[
            ...
            ('dynamake', 'WHY',
             '#1 - make_all - Must run actions because the output: all '
             'is not newer than the input: foo'),
    ...
    def test_require_optional(self) -> None:
        ...
        self.check(_register, log=[
            ...
            ('dynamake', 'DEBUG',
             "#1 - make_all - The optional required: baz does not exist and can't be built"),
            ('dynamake', 'DEBUG', '#1 - make_all - Sync'),
            ('dynamake', 'DEBUG', '#0 - make - Sync'),
            ('dynamake', 'TRACE', '#1.1 - make_foo - Call'),
            ...
            ('dynamake', 'DEBUG', '#1.1 - make_foo - Synced'),
            ('dynamake', 'WHY',
             '#1.1 - make_foo - Must run actions to create the missing output(s): bar'),
        ...
        self.check(_register, log=[
            ...
            ('dynamake', 'DEBUG',
             '#1.1 - make_foo - Can skip actions because all the outputs exist '
    ...
    def test_optional_output(self) -> None:
        ...
        self.check(_register_without, error='Aborting due to previous error', log=[
            ('dynamake', 'TRACE', '#0 - make - Targets: all'),
            ('dynamake', 'DEBUG', '#0 - make - Build the required: all'),
            ('dynamake', 'DEBUG',
             '#0 - make - The required: all will be produced by the spawned: #1 - make_all'),
    ...
    def test_remove_parameterized_persistent_data(self) -> None:
        ...
        self.check(_register, error='make_all/name=all - Failure: false', log=[
            ...
            ('dynamake', 'DEBUG',
             '#1 - make_all/name=all - Nonexistent required output(s): {*name}'),
    ...
    def test_add_final_action(self) -> None:
        ...
        self.check(_register_with, log=[
            ...
            ('dynamake', 'DEBUG', '#1 - make_all - No inputs'),
            ('dynamake', 'WHY',
             '#1 - make_all - Must run actions because changed to add action(s)'),
    ...
    def test_abandon_output(self) -> None:
        ...
        self.check(_register_without, log=[
            ...
            ('dynamake', 'DEBUG', '#1 - make_all - Synced'),
            ('dynamake', 'WHY',
             '#1 - make_all - Must run actions because changed to abandon the output: foo'),
            ('dynamake', 'FILE', '#1 - make_all - Remove the stale output: all'),
            ('dynamake', 'INFO', '#1 - make_all - Run: touch all'),
            ('dynamake', 'DEBUG', '#0 - make - Sync'),
            ('dynamake', 'TRACE', '#1 - make_all - Success: touch all'),
    ...
    def test_abandon_final_action(self) -> None:
        ...
        self.check(_register_without, log=[
            ...
            ('dynamake', 'DEBUG', '#1 - make_all - Has the output: all time: 1'),
            ('dynamake', 'WARNING',
             '#1 - make_all - Skipped some action(s) even though changed '
    ...
    def test_add_required(self) -> None:
        ...
        self.check(_register_with, log=[
            ...
            ('dynamake', 'DEBUG', '#1 - make_all - Newest input: foo time: 0'),
            ('dynamake', 'WHY',
             '#1 - make_all - Must run actions because changed to require: foo'),
            ('dynamake', 'FILE', '#1 - make_all - Remove the stale output: all'),
            ('dynamake', 'INFO', '#1 - make_all - Run: touch all'),
            ('dynamake', 'DEBUG', '#0 - make - Sync'),
            ('dynamake', 'TRACE', '#1 - make_all - Success: touch all'),
    ...
    def test_remove_required(self) -> None:
        ...
        self.check(_register_without, log=[
            ...
            ('dynamake', 'DEBUG', '#1 - make_all - No inputs'),
            ('dynamake', 'WHY',
             '#1 - make_all - Must run actions because changed to not require: foo'),
            ('dynamake', 'FILE', '#1 - make_all - Remove the stale output: all'),
            ('dynamake', 'INFO', '#1 - make_all - Run: touch all'),
            ('dynamake', 'DEBUG', '#0 - make - Sync'),
            ('dynamake', 'TRACE', '#1 - make_all - Success: touch all'),
