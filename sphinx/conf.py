...
latex_documents = [
    (master_doc, 'DynaMake.tex', 'DynaMake Documentation',
...
man_pages = [
    (master_doc, 'dynamake', 'DynaMake Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DynaMake', 'DynaMake Documentation',
     author, 'DynaMake', 'Dynamic Make in Python',
     'Miscellaneous'),
]
